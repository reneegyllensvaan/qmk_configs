// ## Miryoku Notes
//   - Fixed: Lack of a holdable delete/backspace key is a bit annoying, consider putting it on a layer
//     - Addressed by nav layer
//   - Fixed: Esc and Ret positions should be swapped, Esc is much more common
//
//   - Left thumb layers
//     - Media and Mouse could fit on the same layer, freeing up RT3 for shift or new layer
//     - Mouse layer is a comfortable position, could maybe put Nav there since that's a "parking" mode?
//     - Could maybe utilize left hand in RT3 layer?
//     - Will probably merge mouse layer to RT1, and put shift on RT3
//   - Mod tap does not work when typing fast but in proper order (e.g. Pn -> Pt -> Rt -> Rn sends "nt" when typing too quickly)
